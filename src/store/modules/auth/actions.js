...
import { SET_USER_TOKEN_DATA_MUTATION, SIGNUP_ACTION, LOGIN_ACTION } from '../../storeConstants'
...
export default {
    async [LOGIN_ACTION](context, payload) {
        ...
        let response = '';
        try {
            response = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCHakZQ2qEmJbyYUwCCctVPya8iVDiseEo`, postData);
